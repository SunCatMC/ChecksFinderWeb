...
/** @type {string} */
const CACHE_VERSION = '1746433701|11006706181';
/** @type {string} */
const CACHE_PREFIX = 'ChecksFinder-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ChecksFinder.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ChecksFinder.html","ChecksFinder.js","ChecksFinder.offline.html","ChecksFinder.icon.png","ChecksFinder.apple-touch-icon.png","ChecksFinder.audio.worklet.js","ChecksFinder.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["ChecksFinder.wasm","ChecksFinder.pck"];
